...
# Allow larger request bodies for photo uploads (base64-encoded photos from mobile)
...
SITE_URL = os.environ.get("SITE_URL", "https://macnova-machinery-app.onrender.com")
